  ...
  const fetchData = async () => {
    axios
      ...
      .then((response) => {
        ...
        const trailerid = response.data.videos.results.find(vid => vid.name === "Official Trailer")
  ...
  return (
    <div>
      ...
      <div className="flex justify-center ">
        <div className="flex flex-col items-center md:flex-row md:max-w-2xl lg:max-w-3xl absolute xl:max-w-4xl 2xl:max-w-5xl md:mt-[-300px] mt-[-200px] text-white ">
        ...
        <>
          ...
          <div className="float-left w-[70%] md:pl-12 ">
            ...
            <div className="grid grid-flow-col auto-cols-max gap-4 mb-3">
              ...
              <p className="text-cyan-600 text-sm md:text-base">{movieData?.runtime} min</p>
            </div>
